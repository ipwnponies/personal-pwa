...
export const reorderById = (items, activeId, overId) => {
  ...
  // Equivalent to @dnd-kit/sortable's `arrayMove`, inlined so this module
  // stays pure-function-only — it is also imported by aquarium and doodle,
  // which must not transitively pull in React/dnd-kit.
