---
title: 'When to Use Static Generation v.s. Server-sid Rendering'
date: '2020-01-02'
---

We recommend using **Static Generation** (with and without data) whenever possible because your page can be built once
and served by teh CDN, which makes it much faster than having a server render the page on every request.
